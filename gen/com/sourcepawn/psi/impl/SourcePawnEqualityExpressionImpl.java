...
public class SourcePawnEqualityExpressionImpl extends SourcePawnExpressionImpl implements SourcePawnEqualityExpression {

  public SourcePawnEqualityExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof SourcePawnVisitor) ((SourcePawnVisitor)visitor).visitEqualityExpression(this);
