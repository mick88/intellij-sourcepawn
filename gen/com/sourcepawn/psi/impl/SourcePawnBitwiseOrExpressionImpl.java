...
public class SourcePawnBitwiseOrExpressionImpl extends SourcePawnExpressionImpl implements SourcePawnBitwiseOrExpression {

  public SourcePawnBitwiseOrExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof SourcePawnVisitor) ((SourcePawnVisitor)visitor).visitBitwiseOrExpression(this);
