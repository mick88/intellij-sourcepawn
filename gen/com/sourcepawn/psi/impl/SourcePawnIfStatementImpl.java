...
public class SourcePawnIfStatementImpl extends ASTWrapperPsiElement implements SourcePawnIfStatement {

  public SourcePawnIfStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof SourcePawnVisitor) ((SourcePawnVisitor)visitor).visitIfStatement(this);
