...
public class SourcePawnBitwiseAndExpressionImpl extends SourcePawnExpressionImpl implements SourcePawnBitwiseAndExpression {

  public SourcePawnBitwiseAndExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof SourcePawnVisitor) ((SourcePawnVisitor)visitor).visitBitwiseAndExpression(this);
