...
public class SourcePawnDoWhileStatementImpl extends ASTWrapperPsiElement implements SourcePawnDoWhileStatement {

  public SourcePawnDoWhileStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof SourcePawnVisitor) ((SourcePawnVisitor)visitor).visitDoWhileStatement(this);
