...
public class SourcePawnTernaryExpressionImpl extends SourcePawnExpressionImpl implements SourcePawnTernaryExpression {

  public SourcePawnTernaryExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof SourcePawnVisitor) ((SourcePawnVisitor)visitor).visitTernaryExpression(this);
