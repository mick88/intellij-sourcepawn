...
public class SourcePawnLocalVarDeclarationImpl extends ASTWrapperPsiElement implements SourcePawnLocalVarDeclaration {

  public SourcePawnLocalVarDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof SourcePawnVisitor) ((SourcePawnVisitor)visitor).visitLocalVarDeclaration(this);
