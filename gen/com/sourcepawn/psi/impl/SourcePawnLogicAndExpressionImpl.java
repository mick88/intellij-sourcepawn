...
public class SourcePawnLogicAndExpressionImpl extends SourcePawnExpressionImpl implements SourcePawnLogicAndExpression {

  public SourcePawnLogicAndExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof SourcePawnVisitor) ((SourcePawnVisitor)visitor).visitLogicAndExpression(this);
